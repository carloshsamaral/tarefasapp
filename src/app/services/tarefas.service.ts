...
export class TarefasService {
   ...
   */
   ...
   editar(requet : EditarTarefasRequest):Observable<EditarTarefasResponse>{
      return this.httpClient.put<EditarTarefasResponse>(environment.tarefasApi + "/alterar/", requet,{
        headers: this.getHttpHeader()
    });
   }
